# Jaco's code for plotting the parton level posterior (needed to reproduce the thesis exactly)
...
for i, df in enumerate(dfs):
    ...
    if col_idx == 1:
        ...
        plotter.plot(ax, df, coeff1="ctGRe", coeff2="ctu8",
                     ax_labels=[coeff_dict["ctGRe"], coeff_dict["ctu8"]], kde=order[i], colors = colors123,
...
fig.savefig('/data/theorie/pherbsch/ML4EFT/subproj/random_plot_bin/parton_posterior.png')