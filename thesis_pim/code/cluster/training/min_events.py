# This code checks which of the datasets for training neural networks has the least number of events. As we can can't go above that.
...
top_dir = '/data/theorie/pherbsch/ML4EFT/thesis_pim/data/hadron_level_data/event'
sm_dir = '/data/theorie/pherbsch/ML4EFT/thesis_pim/data/hadron_level_data/event/tt_sm'
