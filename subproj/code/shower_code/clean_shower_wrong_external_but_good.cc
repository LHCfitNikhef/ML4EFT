...
void get_bjets(std::vector<fastjet::PseudoJet> &b_jets, std::vector<fastjet::PseudoJet> &visible_particles, fastjet::JetDefinition &jetDef, double zcut = 0, double beta = 0, double Rparam = 0)
{
