"""
This file contains a work-in-progress sample approach
to implementing reweighting in the ML4EFT framework.
...
import ML4EFT_own.code.src.ml4eft.core.classifier as classifier
import ML4EFT_own.code.src.ml4eft.analyse.analyse as analyse


##### SETTINGS #####
coeffs = [#'cHu',
			"ctGRe"]#_ctGRe"]
output_dir = "/data/theorie/wgautier/wgautier/followup/models"
runcard = "/data/theorie/wgautier/wgautier/followup/runcards/train_test_tt_sep_wts.json"
options = {
