...
class EventDataset(data.Dataset):
    ...
    def load_events(self):
        ...
        path_eft_dict = {'5': 'eft_5.lhe', '10': 'eft_10.lhe'}
        path_sm_dict = {'5': 'sm_5.lhe', '10': 'sm_10.lhe'}
    ...
    def __getitem__(self, idx):
        ...
        if self.resc:
            data_tuple = (
            self.data_eft_resc['5'][0][idx], self.data_sm_resc['5'][0][idx], self.data_eft_resc['10'][0][idx],
            self.data_sm_resc['10'][0][idx])
            weight_tuple = (
            self.data_eft_resc['5'][1][idx], self.data_sm_resc['5'][1][idx], self.data_eft_resc['10'][1][idx],
            self.data_sm_resc['10'][1][idx])
            label_tuple = (
            self.data_eft_resc['5'][2][idx], self.data_sm_resc['5'][2][idx], self.data_eft_resc['10'][2][idx],
            self.data_sm_resc['10'][2][idx])
        elif self.standardized:
            data_tuple = (
            self.data_eft_std['5'][0][idx], self.data_sm_std['5'][0][idx], self.data_eft_std['10'][0][idx],
            self.data_sm_std['10'][0][idx])
            weight_tuple = (
            self.data_eft_std['5'][1][idx], self.data_sm_std['5'][1][idx], self.data_eft_std['10'][1][idx],
            self.data_sm_std['10'][1][idx])
            label_tuple = (
            self.data_eft_std['5'][2][idx], self.data_sm_std['5'][2][idx], self.data_eft_std['10'][2][idx],
            self.data_sm_std['10'][2][idx])
        else:
            data_tuple = (self.data_eft['5'][0][idx], self.data_sm['5'][0][idx], self.data_eft['10'][0][idx],
                          self.data_sm['10'][0][idx])
            weight_tuple = (self.data_eft['5'][1][idx], self.data_sm['5'][1][idx], self.data_eft['10'][1][idx],
                            self.data_sm['10'][1][idx])
            label_tuple = (self.data_eft['5'][2][idx], self.data_sm['5'][2][idx], self.data_eft['10'][2][idx],
                           self.data_sm['10'][2][idx])
...
def visualize(data, labels):
    ...
    for i in range(len(data)):
        ...
        plt.xlabel(r'$m_{tt}\;\mathrm{(rescaled)}$')
...
def make_predictions(network_path, train_dataset, val_dataset):
    ...
    im = plt.imshow(Z, cmap=plt.cm.Blues, aspect=(1000 - 2 * mt) / (y_max - y_min), extent=[2 * mt, 1000, y_min, y_max],
                    origin='lower')
    plt.colorbar(im)
