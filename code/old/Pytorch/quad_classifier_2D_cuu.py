...
class EventDataset(data.Dataset):
    ...
    def lhe_loader_v2(self,
                      path):  # TODO: the current implementation is too slow: it runs over all the events in the file (500K)
        """
    ...
    def visualize(self):
        ...
        data_sm = self.data_sm_std['-2.0'][0].view(-1).numpy()
        data_eft_15 = self.data_eft_std['-2.0'][0].view(-1).numpy()
    ...
    def __getitem__(self, idx):
        ...
        if self.resc:
            ...
            self.data_sm_resc['10'][0][idx], self.data_eft_resc['15'][0][idx], self.data_sm_resc['15'][0][idx])
            weight_tuple = (
            self.data_eft_resc['5'][1][idx], self.data_sm_resc['5'][1][idx], self.data_eft_resc['10'][1][idx],
            self.data_sm_resc['10'][1][idx], self.data_eft_resc['15'][1][idx], self.data_sm_resc['15'][1][idx])
            label_tuple = (
            self.data_eft_resc['5'][2][idx], self.data_sm_resc['5'][2][idx], self.data_eft_resc['10'][2][idx],
            self.data_sm_resc['10'][2][idx], self.data_eft_resc['15'][2][idx], self.data_sm_resc['15'][2][idx])
...
def training_loop(n_epochs, optimizer, model, train_loader, val_loader, c_values, path):#, loss_ana):
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        #     shutil.copyfile(path + 'trained_nn_{}.pt'.format(stopping_point),
        #                     path + 'trained_nn.pt'.format(stopping_point))
