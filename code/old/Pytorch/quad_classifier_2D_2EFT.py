...
def plot_predictions_1d(network_path, network_size, ctg, cuu, epochs, mean, std):
    animate_learning_1d(path, network_size, ctg, cuu, epochs, mean, std)


    mtt, f_pred = make_predictions_1d(network_path + 'trained_nn.pt', network_size, ctg, cuu, mean, std)
    ...
    plt.ylim((0, 1))
    plt.title('NN versus analytical at cuu = {} and ctg = {}'.format(cuu, ctg))
    plt.legend()
