...
event_path = "/Users/jaco/Documents/ML4EFT/data/events/quad/cHW/events_0.npy"
...
def plot_benchmark(event_path, cHW, cHq3, title, lin=False, quad=False):
    ...
    cross_section_vh = [vh_prod.dsigma_dmvh(mvh, cHW=cHW, cHq3=cHq3, lin=lin, quad=quad) for mvh in x]
    ...
    ax1.plot(x, cross_section_vh, '-', c='C1', label=r'$\rm{FormCalc}\;\rm{full}$')
    ...
    ax1.text(0.05, 0.2, r'$\rm{cHB=%d}$' % cHq3, transform=ax1.transAxes)
...
fig = plot_benchmark(event_path, 10, 0, title, lin=False, quad=True)
fig.savefig("/Users/jaco/Documents/ML4EFT/code/higgs21/plots/vtest.pdf")