...
def get_nn_ratio(x, c1, c2):
    ...
    for mc_run in range(1, n_models + 1):
        ...
        cross_terms.append(n_cross_out)
        ratios.append(r)

    return ratios, cross_terms
...
# cross_term = get_truth_ratio(0.4, 1, 1, lin=False, quad=True) - get_truth_ratio(0.4, 0, 1, lin=False, quad=True) - get_truth_ratio(0.4, 1, 0, lin=False, quad=True) + get_truth_ratio(0.4, 0, 0, lin=False, quad=True)
#
# ratios_nn, cross_terms = get_nn_ratio(torch.tensor([0.4, 0]), 1, 1)
