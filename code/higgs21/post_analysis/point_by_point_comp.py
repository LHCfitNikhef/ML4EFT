...
plt.tight_layout()
plt.savefig('/data/theorie/jthoeve/ML4EFT_higgs/plots/18_11/point_by_point_cHW_2_all.pdf')
...
plt.ylim((np.min(x), np.max(x)))
plt.tight_layout()
plt.savefig('/data/theorie/jthoeve/ML4EFT_higgs/plots/18_11/point_by_point_cHW_2_median.pdf')
