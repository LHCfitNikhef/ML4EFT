...
nn_pair_all_lin = os.path.join('/data/theorie/jthoeve/ns_samples/zh_llbb/nn_pair_all_lin', '{}_{}', 'posterior_{}_{}.json')
nn_pair_ptz_lin = os.path.join('/data/theorie/jthoeve/ns_samples/zh_llbb/nn_pair_ptz_lin', '{}_{}', 'posterior_{}_{}.json')
binned_pair_ptz_lin = os.path.join('/data/theorie/jthoeve/ns_samples/zh_llbb/binned_pair_ptz_lin', '{}_{}', 'posterior_{}_{}.json')

paths_plot_0 = [binned_pair_ptz_lin, nn_pair_ptz_lin]
#paths_plot_0 = [nn_pair_ptz_lin, nn_pair_all_lin]
#labels_0 = [r"$\mathrm{ML}\;\mathrm{model}\;(p_T^Z)$", r"$\mathrm{ML}\;\mathrm{model}\;(7\;\mathrm{features})$", r'$\mathrm{SM}$']

labels_0 = [r"$p_T^Z\in[75, 150, 250, 400, \infty)\:\mathrm{GeV}$", r"$\mathrm{ML}\;\mathrm{model}\;(p_T^Z)$", r'$\mathrm{SM}$']
...
fig_0.savefig('/data/theorie/jthoeve/ML4EFT_jan/ML4EFT/plots/2022/28_09/zh_llbb_pair_lin_wo_all.pdf')
