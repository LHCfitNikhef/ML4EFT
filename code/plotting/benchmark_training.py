...
from ml4eft.analyse import analyse
...
for rep in range(n_reps):
    ...
    loaded_model = classifier.Classifier([1, 25, 25, 25, 1])
    ...
    ax.plot(x, NN11, color='C1', linestyle='solid')
    ax.plot(x, NN2, color='C2', linestyle='solid')
    ax.plot(x, NN22, color='C3', linestyle='solid')
...
fig.savefig('./ttparton_reweighting_benchmark.pdf')
