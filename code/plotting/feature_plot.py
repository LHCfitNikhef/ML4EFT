...
dfs_eft = []
for c in coeff:
    dfs_eft.append(pd.read_pickle("/data/theorie/jthoeve/ML4EFT_jan/ML4EFT/training_data/zh_llbb_final/zh_{}_{}/events_0.pkl.gz".format(c,c)).iloc[1:,:])
...
fig.savefig(os.path.join(plot_directory, 'zh_quad_dist.pdf'))