...
samples_binned_quad_mtt_1 = '/data/theorie/jthoeve/ns_samples/tt_parton/binned_glob_quad_mtt_c/posterior.json'
samples_binned_quad_mtt_2 = '/data/theorie/jthoeve/ns_samples/tt_parton/binned_glob_quad_mtt_f/posterior.json'
samples_binned_quad_mtt_3 = '/data/theorie/jthoeve/ML4EFT/ns_samples/binned_glob_quad_mtt_binning_3/posterior.json'

# PLOT 4

df_plot_4 = [Analyse.posterior_loader(samples_binned_quad_mtt_1),
             Analyse.posterior_loader(samples_binned_quad_mtt_2),
...
for i, df in enumerate(dfs):
    ...
    if col_idx == 1:
        ...
        plotter.plot(ax, df, coeff1="ctGRe", coeff2="ctu8",
                     ...
                     labels=labels[i], loc="lower right", colors=['C0', 'C1', 'C7', 'C2', 'C4'])
    else:
        plotter.plot(ax, df, coeff1="ctGRe", coeff2="ctu8",
                     ax_labels=[coeff_dict["ctGRe"], coeff_dict["ctu8"]], kde=order[i],
                     labels=labels[i], loc="lower right", colors=['C0', 'C1', 'C7', 'C2', 'C4'])
...
fig.savefig('/data/theorie/jthoeve/ML4EFT/plots/referee/tt_parton_bin_limit_3.pdf')
