...
C     
C     Process: g g > t t~ FCNC=0 DIM6^2<=1 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFVV2_4_0(W(1,4),W(1,3),W(1,1),W(1,2),GC_728,GC_727,AMP(1))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_6,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,4),W(1,3),W(1,5),GC_7,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV11_9_0(W(1,4),W(1,3),W(1,5),GC_725,GC_726,AMP(3))
      CALL FFV6_1(W(1,3),W(1,1),GC_7,MDL_MT, ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV6_0(W(1,4),W(1,5),W(1,2),GC_7,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV11_9_0(W(1,4),W(1,5),W(1,2),GC_725,GC_726,AMP(5))
      CALL FFV11_9_1(W(1,3),W(1,1),GC_725,GC_726,MDL_MT, ZERO,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFV6_0(W(1,4),W(1,5),W(1,2),GC_7,AMP(6))
      CALL FFV6_2(W(1,4),W(1,1),GC_7,MDL_MT, ZERO,W(1,5))
C     Amplitude(s) for diagram number 7
      CALL FFV6_0(W(1,5),W(1,3),W(1,2),GC_7,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV11_9_0(W(1,5),W(1,3),W(1,2),GC_725,GC_726,AMP(8))
      CALL FFV11_9_2(W(1,4),W(1,1),GC_725,GC_726,MDL_MT, ZERO,W(1,5))
C     Amplitude(s) for diagram number 9
      CALL FFV6_0(W(1,5),W(1,3),W(1,2),GC_7,AMP(9))
C     JAMPs contributing to orders DIM6=0
      JAMP(1,1)=+IMAG1*AMP(2)-AMP(4)
      JAMP(2,1)=-IMAG1*AMP(2)-AMP(7)
C     JAMPs contributing to orders DIM6=1
      JAMP(1,2)=+IMAG1*AMP(1)+IMAG1*AMP(3)-AMP(5)-AMP(6)
      JAMP(2,2)=-IMAG1*AMP(1)-IMAG1*AMP(3)-AMP(8)-AMP(9)
