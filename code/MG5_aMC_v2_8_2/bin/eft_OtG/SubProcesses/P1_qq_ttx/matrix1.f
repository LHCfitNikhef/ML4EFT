...
C     
C     Process: u u~ > t t~ FCNC=0 DIM6^2<=1 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFFF10_14_18_19_6_8_0(W(1,1),W(1,2),W(1,4),W(1,3),GC_472
     $ ,GC_575,GC_589,GC_592,GC_150,GC_471,AMP(1))
      CALL FFFF10_14_18_19_6_8_0(W(1,1),W(1,2),W(1,4),W(1,3),GC_474
     $ ,GC_576,GC_590,GC_593,GC_178,GC_473,AMP(2))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_2,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(3))
C     Amplitude(s) for diagram number 3
      CALL FFV11_9_0(W(1,4),W(1,3),W(1,5),GC_813,GC_814,AMP(4))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_7,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV6_0(W(1,4),W(1,3),W(1,5),GC_7,AMP(5))
C     Amplitude(s) for diagram number 5
      CALL FFV11_9_0(W(1,4),W(1,3),W(1,5),GC_725,GC_726,AMP(6))
      CALL FFV2_8_3(W(1,1),W(1,2),GC_651,GC_660,MDL_MZ, FK_MDL_WZ,W(1
     $ ,5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_8_0(W(1,4),W(1,3),W(1,5),GC_651,GC_660,AMP(7))
C     Amplitude(s) for diagram number 7
      CALL FFV11_9_0(W(1,4),W(1,3),W(1,5),GC_721,GC_722,AMP(8))
C     Amplitude(s) for diagram number 8
      CALL FFV4_0(W(1,4),W(1,3),W(1,5),GC_948,AMP(9))
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,4),W(1,3),W(1,5),GC_938,AMP(10))
C     JAMPs contributing to orders DIM6=0
      JAMP(1,1)=-AMP(3)+1D0/6D0*AMP(5)-AMP(7)
      JAMP(2,1)=+1D0/2D0*(-AMP(5))
C     JAMPs contributing to orders DIM6=1
      JAMP(1,2)=-AMP(1)+1D0/6D0*AMP(2)-AMP(4)+1D0/6D0*AMP(6)-AMP(8)
     $ -AMP(9)-AMP(10)
      JAMP(2,2)=+1D0/2D0*(-AMP(2)-AMP(6))
