void selection_2()
{
  ...
  S3_SQRTS_0->SetBinContent(28,50857.653291);
  S3_SQRTS_0->SetBinContent(29,275423.909511);
  S3_SQRTS_0->SetBinContent(30,342133.287594);
  S3_SQRTS_0->SetBinContent(31,388367.472404);
  S3_SQRTS_0->SetBinContent(32,410163.665243);
  S3_SQRTS_0->SetBinContent(33,385065.073489);
  S3_SQRTS_0->SetBinContent(34,364589.880216);
  S3_SQRTS_0->SetBinContent(35,350719.684773);
  S3_SQRTS_0->SetBinContent(36,326942.092585);
  S3_SQRTS_0->SetBinContent(37,307127.399095);
  S3_SQRTS_0->SetBinContent(38,252306.817106);
  S3_SQRTS_0->SetBinContent(39,258911.714936);
  S3_SQRTS_0->SetBinContent(40,223245.226654);
  S3_SQRTS_0->SetBinContent(41,2669036.1231); // overflow
