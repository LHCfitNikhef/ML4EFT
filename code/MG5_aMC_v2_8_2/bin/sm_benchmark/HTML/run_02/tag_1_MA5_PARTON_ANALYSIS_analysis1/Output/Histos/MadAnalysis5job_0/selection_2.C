void selection_2()
{
  ...
  S3_SQRTS_0->SetBinContent(28,45571.946688);
  S3_SQRTS_0->SetBinContent(29,192645.028272);
  S3_SQRTS_0->SetBinContent(30,270842.339748);
  S3_SQRTS_0->SetBinContent(31,289485.442484);
  S3_SQRTS_0->SetBinContent(32,294146.243168);
  S3_SQRTS_0->SetBinContent(33,282235.34142);
  S3_SQRTS_0->SetBinContent(34,278610.340888);
  S3_SQRTS_0->SetBinContent(35,269806.639596);
  S3_SQRTS_0->SetBinContent(36,242877.735644);
  S3_SQRTS_0->SetBinContent(37,237181.234808);
  S3_SQRTS_0->SetBinContent(38,227341.833364);
  S3_SQRTS_0->SetBinContent(39,199377.22926);
  S3_SQRTS_0->SetBinContent(40,191609.32812);
  S3_SQRTS_0->SetBinContent(41,2156899.31654); // overflow
