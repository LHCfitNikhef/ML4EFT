...
def plot_predictions(network_path, network_size, train_dataset, quadratic, ctg):
    if quadratic:
        mtt, f_pred, n_alpha_nn, n_alpha_n_beta_nn = make_predictions(network_path + 'trained_nn.pt', network_size, train_dataset, quadratic, ctg)
        n_alpha_n_beta_nn = np.array(n_alpha_n_beta_nn)
    else:
        mtt, f_pred, n_alpha_nn = make_predictions(network_path + 'trained_nn.pt', network_size, train_dataset, quadratic, ctg)
