...
C     first try in the current directory
      ...
      LHAPATH='/data/theorie/smefit/MG5_v3_0_0//PDFsets'
      INQUIRE(FILE=LHAPATH, EXIST=EXISTS)
      IF(EXISTS)RETURN
      LHAPATH='/data/theorie/smefit/MG5_v3_0_0//../lhapdf/pdfsets/6.1/'
      INQUIRE(FILE=LHAPATH, EXIST=EXISTS)
      IF(EXISTS)RETURN
      LHAPATH='/data/theorie/smefit/MG5_v3_0_0//../lhapdf/pdfsets/'
      INQUIRE(FILE=LHAPATH, EXIST=EXISTS)
      IF(EXISTS)RETURN
      LHAPATH='./PDFsets'
