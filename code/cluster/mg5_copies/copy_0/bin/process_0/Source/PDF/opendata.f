...
C     First try system wide (for cluster if define)
      ...
      TEMPNAME='/data/theorie/smefit/MG5_v3_0_0/'//TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=1)
      RETURN
 1    TEMPNAME='/data/theorie/smefit/MG5_v3_0_0//Pdfdata/'//TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=2)
      RETURN
 2    TEMPNAME='/data/theorie/smefit/MG5_v3_0_0//lhapdf'//TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=3)
      RETURN
 3    TEMPNAME='/data/theorie/smefit/MG5_v3_0_0//../lhapdf/pdfsets/'/
     $ /TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=4)
      RETURN
 4    TEMPNAME='/data/theorie/smefit/MG5_v3_0_0//../lhapdf/pdfsets/6.1'
     $ //'/'//TABLEFILE
