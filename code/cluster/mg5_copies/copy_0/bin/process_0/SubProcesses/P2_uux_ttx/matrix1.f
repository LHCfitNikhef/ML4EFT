...
C     
C     Process: u u~ > t t~ NP<=1 / a z h h1 w+ w+ w1+ w1+ z1 t1 @2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFFF14_16_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_50,-GC_50,AMP(1)
     $ )
C     Amplitude(s) for diagram number 2
      CALL FFFF14_16_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_51,-GC_51,AMP(2)
     $ )
C     Amplitude(s) for diagram number 3
      CALL FFFF4_0(W(1,4),W(1,2),W(1,1),W(1,3),GC_45,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFFF18_0(W(1,4),W(1,2),W(1,1),W(1,3),GC_59,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFFF15_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_58,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFFF3_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_44,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFFF4_0(W(1,4),W(1,2),W(1,1),W(1,3),GC_48,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFFF3_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_47,AMP(8))
      CALL FFV2P0_3(W(1,1),W(1,2),GC_1273,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_6,AMP(9))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_6,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,4),W(1,3),W(1,5),GC_976,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_6,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV9_0(W(1,4),W(1,3),W(1,5),GC_977,AMP(12))
      CALL FFV9P0_3(W(1,1),W(1,2),GC_1274,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_6,AMP(13))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+AMP(1)-1D0/6D0*AMP(2)+AMP(5)+AMP(6)+AMP(8)+1D0/6D0
     $ *AMP(9)+1D0/6D0*AMP(10)+1D0/6D0*AMP(11)+1D0/6D0*AMP(12)+1D0/6D0
     $ *AMP(13)
      JAMP(2,1)=+1D0/2D0*AMP(2)+AMP(3)+AMP(4)+AMP(7)-1D0/2D0*AMP(9)
     $ -1D0/2D0*AMP(10)-1D0/2D0*AMP(11)-1D0/2D0*AMP(12)-1D0/2D0*AMP(13)
