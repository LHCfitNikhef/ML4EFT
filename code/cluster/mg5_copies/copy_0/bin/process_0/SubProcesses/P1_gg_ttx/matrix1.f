...
C     
C     Process: g g > t t~ NP<=1 / a z h h1 w+ w+ w1+ w1+ z1 t1 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFVV3_0(W(1,4),W(1,3),W(1,1),W(1,2),GC_989,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL FFVV1_0(W(1,4),W(1,3),W(1,1),W(1,2),GC_988,AMP(2))
      CALL VVV5P0_1(W(1,1),W(1,2),GC_7,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,4),W(1,3),W(1,5),GC_976,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_6,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV9_0(W(1,4),W(1,3),W(1,5),GC_977,AMP(5))
      CALL VVV8P0_1(W(1,1),W(1,2),GC_16,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_6,AMP(6))
      CALL VVV3P0_1(W(1,1),W(1,2),GC_347,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_6,AMP(7))
      CALL VVV7P0_1(W(1,1),W(1,2),GC_15,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_6,AMP(8))
      CALL FFV2_1(W(1,3),W(1,1),GC_976,MDL_MT,MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,4),W(1,5),W(1,2),GC_6,AMP(9))
      CALL FFV1_1(W(1,3),W(1,1),GC_6,MDL_MT,MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,4),W(1,5),W(1,2),GC_976,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,4),W(1,5),W(1,2),GC_6,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV9_0(W(1,4),W(1,5),W(1,2),GC_977,AMP(12))
      CALL FFV9_1(W(1,3),W(1,1),GC_977,MDL_MT,MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,4),W(1,5),W(1,2),GC_6,AMP(13))
      CALL FFV2_2(W(1,4),W(1,1),GC_976,MDL_MT,MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,5),W(1,3),W(1,2),GC_6,AMP(14))
      CALL FFV1_2(W(1,4),W(1,1),GC_6,MDL_MT,MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,5),W(1,3),W(1,2),GC_976,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,5),W(1,3),W(1,2),GC_6,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV9_0(W(1,5),W(1,3),W(1,2),GC_977,AMP(17))
      CALL FFV9_2(W(1,4),W(1,1),GC_977,MDL_MT,MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,5),W(1,3),W(1,2),GC_6,AMP(18))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+IMAG1*AMP(1)+IMAG1*AMP(2)+IMAG1*AMP(3)+IMAG1*AMP(4)
     $ +IMAG1*AMP(5)+IMAG1*AMP(6)+IMAG1*AMP(7)+IMAG1*AMP(8)-AMP(9)
     $ -AMP(10)-AMP(11)-AMP(12)-AMP(13)
      JAMP(2,1)=-IMAG1*AMP(1)-IMAG1*AMP(2)-IMAG1*AMP(3)-IMAG1*AMP(4)
     $ -IMAG1*AMP(5)-IMAG1*AMP(6)-IMAG1*AMP(7)-IMAG1*AMP(8)-AMP(14)
     $ -AMP(15)-AMP(16)-AMP(17)-AMP(18)
      ...
      AMP2(3)=AMP2(3)+(AMP(3)+AMP(4)+AMP(5)+AMP(6)+AMP(7)+AMP(8))
     $ *DCONJG(AMP(3)+AMP(4)+AMP(5)+AMP(6)+AMP(7)+AMP(8))
      AMP2(9)=AMP2(9)+(AMP(9)+AMP(10)+AMP(11)+AMP(12)+AMP(13))
     $ *DCONJG(AMP(9)+AMP(10)+AMP(11)+AMP(12)+AMP(13))
      AMP2(14)=AMP2(14)+(AMP(14)+AMP(15)+AMP(16)+AMP(17)+AMP(18))
     $ *DCONJG(AMP(14)+AMP(15)+AMP(16)+AMP(17)+AMP(18))
      DO I = 1, NCOLOR
        DO M = 1, NAMPSO
          DO N = 1, NAMPSO
            IF (CHOSEN_SO_CONFIGS(SQSOINDEX1(M,N))) THEN
