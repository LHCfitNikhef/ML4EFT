...
def dsigma_dmtt(mtt, cuGRe, cuu):
    ...
    dsigma_dmtt = integrate.fixed_quad(dsigma_dmtt_dy_vec, y_min, y_max, args=(mtt, cuGRe, cuu), n=100)[0] #TODO: n=100 previously, does n= 10 also give good performances?
    return dsigma_dmtt
